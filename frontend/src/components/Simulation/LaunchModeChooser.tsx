interface Props {
  onChoose: (mode: 'standard' | 'simulation') => void;
}
    ...
    <main className="grid min-h-dvh w-screen place-items-center bg-surface px-5 text-gray-200">
      <section className="w-full max-w-xl">
        <div className="mb-7 text-center">
          ...
          <h1 className="mt-3 text-2xl font-semibold text-gray-100">Choose your replay mode</h1>
          <p className="mt-2 text-sm text-gray-500">Practice a full session or trade a blind large-candle setup.</p>
        </div>
